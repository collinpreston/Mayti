...
public class WeeklyWatchlistFragment extends Fragment {
    ...
    protected WeeklyWatchlistFragment.LayoutManagerType mCurrentLayoutManagerType;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            watchlistItems.addAll(viewModel.getAllStocksForWatchlist(WEEKLY_WATCHLIST_NAME));
        ...
        viewModel.getStockListForWatchlist(WEEKLY_WATCHLIST_NAME).observe(WeeklyWatchlistFragment.this, new Observer<List<Stock>>() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_watchlist_weekly, container, false);
        rootView.setTag(TAG);

        mRecyclerView = rootView.findViewById(R.id.recyclerViewWeekly);
        ...
        mCurrentLayoutManagerType = WeeklyWatchlistFragment.LayoutManagerType.LINEAR_LAYOUT_MANAGER;

        if (savedInstanceState != null) {
            // Restore saved layout manager type.
            mCurrentLayoutManagerType = (WeeklyWatchlistFragment.LayoutManagerType) savedInstanceState
     ...
     */
    public void setRecyclerViewLayoutManager(WeeklyWatchlistFragment.LayoutManagerType layoutManagerType) {
        ...
        switch (layoutManagerType) {
            case GRID_LAYOUT_MANAGER:
                ...
                mCurrentLayoutManagerType = WeeklyWatchlistFragment.LayoutManagerType.GRID_LAYOUT_MANAGER;
                break;
